...
beautiful.init("/home/govind/.config/awesome/themes/govind/theme.lua")
...
tags = {
   ...
   layout = { layouts[2], layouts[10], layouts[1],
              layouts[2], layouts[10], layouts[1], }
}
...
mytextclock = awful.widget.textclock({}, "%c", 1)
...
vicious.register(fswidget, vicious.widgets.fs, "/home: ${/ used_p}%", 15)

-- Reusable separator widget
